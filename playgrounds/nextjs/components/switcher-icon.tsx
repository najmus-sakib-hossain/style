export default function SwitcherIcon() {
    return (
        <div className="relative border h-10 w-10 rounded-full">
            <div className="absolute top-0 left-0 h-full w-1/2 bg-background rounded-tl-full rounded-bl-full" />
            <div className="absolute z-50 border h-4 w-4 rounded-full top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
